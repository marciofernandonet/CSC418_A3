...
{	
	...
	// testing purposes.	
	raytracer.render(width, height, eye, view, up, fov, "phong1.bmp",'p');
	raytracer.render(width, height, eye, view, up, fov, "diffuse1.bmp",'d');
	raytracer.render(width, height, eye, view, up, fov, "sig1.bmp", 's');
	// Render it from a different point of view.
	Point3D eye2(4, 2, 1);
	Vector3D view2(-4, -2, -6);
	raytracer.render(width, height, eye2, view2, up, fov, "phong2.bmp",'p');
	raytracer.render(width, height, eye2, view2, up, fov, "diffuse2.bmp",'d');
	raytracer.render(width, height, eye2, view2, up, fov, "sig2.bmp", 's');
	return 0;
}
